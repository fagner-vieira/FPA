  ...
  <body>
		...
		<div class="container-fluid bgTwo">
			<div class="container">
				<div class="row marginOne">
					<div class="col-lg-6">
						<p class="txtFive"> <strong>Teatro</strong></p>
						<p class="txtFive">A matriz curricular do curso é dividida em dois principais segmentos: teórico e prático. Com isso, conseguimos colaborar tanto na formação intelectual dos nossos alunos, quanto no desenvolvimento da ferramenta de trabalho mais importante: o próprio corpo.<br/><br/>Vale ressaltar que existem ainda duas matrizes nas quais os alunos têm a possibilidade de exercitar e experimentar todos os conhecimentos e técnicas adquiridas ao longo do curso.<br/><br/>• Interpretação teatral: Permite a execução das técnicas interpretativas. Um trabalho em grupo, mas totalmente voltado para o desenvolvimento e crescimento individual.</p>
					</div>
					<div class="col-lg-6">
						<p class="txtFive"> <strong>&nbsp;</strong></p>
						<p class="txtFive">	• Laboratório de Montagem: Referente ao desenvolvimento total da peça, leva em conta o texto, a montagem de cenário, direção e muitos outros aspectos.<br/><br/>A possibilidade de atuação do profissional formado em Teatro é muito diversa, podendo trabalhar como ator em televisão e teatro, lecionar em diversas instituições, dirigir e criar roteiros para peças, além de ter amplo espaço no mercado publicitário.</p>	
						</div>
				</div>
			</div>
		</div>
